...
object KafkaProcessorAdsCallbackEngage ntsModule extends Tw terModule w h Logg ng {
  ...
  def prov desKafkaProcessor(
    ...
    KafkaProcessorProv der.prov deDefaultAtLeastOnceProcessor(
      ...
      s ceValueDeser al zer = NullableScalaSerdes
        .Thr ft[SpendServerEvent](statsRece ver.counter("deser al zerErrors")).deser al zer,
      ...
      adapter = new AdsCallbackEngage ntsAdapter,
