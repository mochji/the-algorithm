...
/**
 * Updates an [[OrderedCursor]]  n t  Prev ous pos  on
 *
 ...
 */
case class OrderedPrev ousCursorUpdater[
  ...
  overr de val underly ng: OrderedPrev ousCursorBu lder[Query] =
    OrderedPrev ousCursorBu lder( dSelector,  ncludeOperat on, ser al zer)
}
