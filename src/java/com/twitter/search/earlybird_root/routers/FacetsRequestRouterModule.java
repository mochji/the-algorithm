...
publ c class FacetsRequestRouterModule extends Tw terModule {
  publ c stat c f nal Str ng T ME_RANGE_F LTER = "facets_t  _range_f lter";

  publ c stat c f nal Str ng SERV NG_RANGE_BOUNDARY_HOURS_AGO_DEC DER_KEY =
      "superroot_facets_serv ng_range_boundary_h s_ago";

  pr vate Serv ngRangeProv der getServ ngRangeProv der(f nal SearchDec der dec der)
      throws Except on {
    return new Realt  Serv ngRangeProv der(
        dec der, SERV NG_RANGE_BOUNDARY_HOURS_AGO_DEC DER_KEY);
  }
