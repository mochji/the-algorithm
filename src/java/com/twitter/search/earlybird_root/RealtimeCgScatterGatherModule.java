...
publ c class Realt  CgScatterGat rModule extends ScatterGat rModule {
  pr vate stat c f nal Logger LOG =
      LoggerFactory.getLogger(Realt  CgScatterGat rModule.class);

  /**
   * Prov des a scatter gat r serv ce for t  realt  _cg cluster.
   */
  @Prov des
  @S ngleton
