...
JOB_NAME="summ ngb rd_s mclusters_v2_t et_job_${ENV}"
...
#set -v
 ...
 ron subm  "${AURORA_PATH}" "d st/${JAR_NAME}" com.tw ter.s mclusters_v2.summ ngb rd.storm.T etJobRunner --env "$ENV" --dc "$CLUSTER"
