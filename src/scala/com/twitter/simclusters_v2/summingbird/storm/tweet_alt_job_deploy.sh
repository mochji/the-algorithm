#!/b n/bash
# scr pt to deploy s mcluster storm job to C 
...
JAR_NAME="t et-s mclusters-storm-job.tar"
JOB_NAME="summ ngb rd_s mclusters_v2_t et_alt_job_${ENV}"

BASE_D R="src/scala/com/tw ter/s mclusters_v2/summ ngb rd"
./bazel bundle --bundle-jvm-arch ve=tar ${BASE_D R}:t et-s mclusters-storm-job || ex  1
...
#set -v
 ...
 ron subm  "${AURORA_PATH}" "d st/${JAR_NAME}" com.tw ter.s mclusters_v2.summ ngb rd.storm.T etJobRunner --env "$ENV" --dc "$CLUSTER" --alt "alt" --us ngLogFavScore
