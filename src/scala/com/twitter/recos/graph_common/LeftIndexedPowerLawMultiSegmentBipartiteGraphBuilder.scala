package com.tw ter.recos.graph_common
 ...
 mport com.tw ter.graphjet.b part e.Left ndexedPo rLawMult Seg ntB part eGraph
 mport com.tw ter.graphjet.b part e.ap .EdgeTypeMask
 mport com.tw ter.graphjet.stats.StatsRece ver

/**
 * T  GraphBu lder bu lds a Left ndexedPo rLawMult Seg ntB part eGraph g ven a set of
 * para ters.
 */
object Left ndexedPo rLawMult Seg ntB part eGraphBu lder {
  ...
  ): Left ndexedPo rLawMult Seg ntB part eGraph = {
    new Left ndexedPo rLawMult Seg ntB part eGraph(
