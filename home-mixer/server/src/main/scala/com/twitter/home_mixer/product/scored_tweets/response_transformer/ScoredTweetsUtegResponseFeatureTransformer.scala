...
object ScoredT etsUtegResponseFeatureTransfor r
    extends Cand dateFeatureTransfor r[tlr.Cand dateT et] {

  overr de val  dent f er: Transfor r dent f er = Transfor r dent f er("ScoredT etsUtegResponse")
  ...
  overr de def transform(cand date: tlr.Cand dateT et): FeatureMap = {
    ...
    val features = FeatureMapBu lder()
      .add(Cand dateS ce dFeature, So (cts.Cand dateT etS ce d.Recom ndedT et))
      .add(SuggestTypeFeature, So (st.SuggestType.Act v yT et))
      .bu ld()
