package com.tw ter.ho _m xer.product.scored_t ets.query_transfor r
 ...
 mport com.tw ter.ho _m xer.product.scored_t ets.query_transfor r.T  l neRanker nNetworkQueryTransfor r._
...
object T  l neRanker nNetworkQueryTransfor r {
...
case class T  l neRanker nNetworkQueryTransfor r[
  ...
  overr de val cand dateT etS ce d = Cand dateT etS ce d.RecycledT et
  overr de val opt ons = t etK ndOpt ons

  overr de def getTensorflowModel(query: Query): Opt on[Str ng] = {
    So (query.params(ScoredT etsParam.Earlyb rdTensorflowModel. nNetworkParam))
  }
