package com.tw ter.users gnalserv ce.s gnals
 ...
 mport com.tw ter.tw stly.thr ftscala.Engage nt tadata.Or g nalT et tadata
    ...
    rawS gnals.map {
      _.map { s gnals =>
        ...
        lookBackW ndowF lteredS gnals
          .collect {
            case RecentEngagedT et(t et d, engagedAt, _: Or g nalT et tadata, _) =>
