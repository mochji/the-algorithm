...
@S ngleton
case class V deoT etsQual yV ewFetc r @ nject() (
  stratoCl ent: Cl ent,
  t  r: T  r,
  stats: StatsRece ver)
   ...
   mport V deoT etsQual yV ewFetc r._
  ...
  overr de protected def toStratoKey(user d: User d): (User d, V deoV ewEngage ntType) =
    (user d, V deoV ewEngage ntType.V deoQual yV ew)
...
object V deoT etsQual yV ewFetc r {
