...
class FeatureStoreT  l nesAuthorS ce @ nject() (
  serv ce dent f er: Serv ce dent f er,
  stats: StatsRece ver)
    extends FeatureS ce {
   mport FeatureStoreT  l nesAuthorS ce._

  val backupS ceStats = stats.scope("feature_store_hydrat on_t  l nes_author")
  val adapterStats = backupS ceStats.scope("adapters")
  overr de def  d: FeatureS ce d = FeatureS ce d.FeatureStoreT  l nesAuthorS ce d
...
object FeatureStoreT  l nesAuthorS ce {
  pr vate val DatasetCac Scope = "feature_store_local_cac _t  l nes_author"
    ...
    Dynam cHydrat onConf g(
      Set(
        GatedFeatures(
          ...
          gate =
            HasParams
              .paramGate(FeatureStoreS ceParams.EnableSeparateCl entForT  l nesAuthors) &
