...
publ c class SW GTYPE_p_omp_lock_t {
  pr vate trans ent long sw gCPtr;

  protected SW GTYPE_p_omp_lock_t(long cPtr, @SuppressWarn ngs("unused") boolean futureUse) {
    sw gCPtr = cPtr;
  }

  protected SW GTYPE_p_omp_lock_t() {
    sw gCPtr = 0;
  }

  protected stat c long getCPtr(SW GTYPE_p_omp_lock_t obj) {
