...
publ c class SW GTYPE_p_p_fa ss__ ndex {
  pr vate trans ent long sw gCPtr;

  protected SW GTYPE_p_p_fa ss__ ndex(long cPtr, @SuppressWarn ngs("unused") boolean futureUse) {
    sw gCPtr = cPtr;
  }

  protected SW GTYPE_p_p_fa ss__ ndex() {
    sw gCPtr = 0;
  }

  protected stat c long getCPtr(SW GTYPE_p_p_fa ss__ ndex obj) {
