...
publ c class SW GTYPE_p_ OWr er {
  pr vate trans ent long sw gCPtr;

  protected SW GTYPE_p_ OWr er(long cPtr, @SuppressWarn ngs("unused") boolean futureUse) {
    sw gCPtr = cPtr;
  }

  protected SW GTYPE_p_ OWr er() {
    sw gCPtr = 0;
  }

  protected stat c long getCPtr(SW GTYPE_p_ OWr er obj) {
