...
publ c class SW GTYPE_p_D rectMap {
  pr vate trans ent long sw gCPtr;

  protected SW GTYPE_p_D rectMap(long cPtr, @SuppressWarn ngs("unused") boolean futureUse) {
    sw gCPtr = cPtr;
  }

  protected SW GTYPE_p_D rectMap() {
    sw gCPtr = 0;
  }

  protected stat c long getCPtr(SW GTYPE_p_D rectMap obj) {
