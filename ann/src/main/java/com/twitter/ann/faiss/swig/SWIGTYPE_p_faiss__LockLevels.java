...
publ c class SW GTYPE_p_fa ss__LockLevels {
  pr vate trans ent long sw gCPtr;

  protected SW GTYPE_p_fa ss__LockLevels(long cPtr, @SuppressWarn ngs("unused") boolean futureUse) {
    sw gCPtr = cPtr;
  }

  protected SW GTYPE_p_fa ss__LockLevels() {
    sw gCPtr = 0;
  }

  protected stat c long getCPtr(SW GTYPE_p_fa ss__LockLevels obj) {
