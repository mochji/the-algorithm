...
publ c class SW GTYPE_p_D rectMap__Type {
  pr vate trans ent long sw gCPtr;

  protected SW GTYPE_p_D rectMap__Type(long cPtr, @SuppressWarn ngs("unused") boolean futureUse) {
    sw gCPtr = cPtr;
  }

  protected SW GTYPE_p_D rectMap__Type() {
    sw gCPtr = 0;
  }

  protected stat c long getCPtr(SW GTYPE_p_D rectMap__Type obj) {
