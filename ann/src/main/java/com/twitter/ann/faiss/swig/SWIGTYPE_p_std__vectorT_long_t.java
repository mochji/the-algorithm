...
publ c class SW GTYPE_p_std__vectorT_long_t {
  pr vate trans ent long sw gCPtr;

  protected SW GTYPE_p_std__vectorT_long_t(long cPtr, @SuppressWarn ngs("unused") boolean futureUse) {
    sw gCPtr = cPtr;
  }

  protected SW GTYPE_p_std__vectorT_long_t() {
    sw gCPtr = 0;
  }

  protected stat c long getCPtr(SW GTYPE_p_std__vectorT_long_t obj) {
