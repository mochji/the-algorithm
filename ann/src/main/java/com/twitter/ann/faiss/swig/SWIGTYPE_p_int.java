...
publ c class SW GTYPE_p_ nt {
  pr vate trans ent long sw gCPtr;

  protected SW GTYPE_p_ nt(long cPtr, @SuppressWarn ngs("unused") boolean futureUse) {
    sw gCPtr = cPtr;
  }

  protected SW GTYPE_p_ nt() {
    sw gCPtr = 0;
  }

  protected stat c long getCPtr(SW GTYPE_p_ nt obj) {
