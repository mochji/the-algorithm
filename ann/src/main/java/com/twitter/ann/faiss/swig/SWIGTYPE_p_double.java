...
publ c class SW GTYPE_p_double {
  pr vate trans ent long sw gCPtr;

  protected SW GTYPE_p_double(long cPtr, @SuppressWarn ngs("unused") boolean futureUse) {
    sw gCPtr = cPtr;
  }

  protected SW GTYPE_p_double() {
    sw gCPtr = 0;
  }

  protected stat c long getCPtr(SW GTYPE_p_double obj) {
