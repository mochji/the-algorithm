...
publ c class SW GTYPE_p_F LE {
  pr vate trans ent long sw gCPtr;

  protected SW GTYPE_p_F LE(long cPtr, @SuppressWarn ngs("unused") boolean futureUse) {
    sw gCPtr = cPtr;
  }

  protected SW GTYPE_p_F LE() {
    sw gCPtr = 0;
  }

  protected stat c long getCPtr(SW GTYPE_p_F LE obj) {
