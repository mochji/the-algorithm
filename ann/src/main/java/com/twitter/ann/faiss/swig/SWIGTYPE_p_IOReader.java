...
publ c class SW GTYPE_p_ OReader {
  pr vate trans ent long sw gCPtr;

  protected SW GTYPE_p_ OReader(long cPtr, @SuppressWarn ngs("unused") boolean futureUse) {
    sw gCPtr = cPtr;
  }

  protected SW GTYPE_p_ OReader() {
    sw gCPtr = 0;
  }

  protected stat c long getCPtr(SW GTYPE_p_ OReader obj) {
