...
publ c class SW GTYPE_p_fa ss__ OWr er {
  pr vate trans ent long sw gCPtr;

  protected SW GTYPE_p_fa ss__ OWr er(long cPtr, @SuppressWarn ngs("unused") boolean futureUse) {
    sw gCPtr = cPtr;
  }

  protected SW GTYPE_p_fa ss__ OWr er() {
    sw gCPtr = 0;
  }

  protected stat c long getCPtr(SW GTYPE_p_fa ss__ OWr er obj) {
