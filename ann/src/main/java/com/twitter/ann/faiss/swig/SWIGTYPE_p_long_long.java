...
publ c class SW GTYPE_p_long_long {
  pr vate trans ent long sw gCPtr;

  protected SW GTYPE_p_long_long(long cPtr, @SuppressWarn ngs("unused") boolean futureUse) {
    sw gCPtr = cPtr;
  }

  protected SW GTYPE_p_long_long() {
    sw gCPtr = 0;
  }

  protected stat c long getCPtr(SW GTYPE_p_long_long obj) {
