...
object RelatedV deoT etT etBasedParams {

  // UTG params
  object EnableUTGParam
      extends FSParam[Boolean](
        na  = "related_v deo_t et_t et_based_enable_utg",
        default = false
      )
  ...
  object EnableS mClustersANNParam
      extends FSParam[Boolean](
        na  = "related_v deo_t et_t et_based_enable_s mclusters",
        default = true
      )
  ...
  object EnableExper  ntalS mClustersANNParam
      extends FSParam[Boolean](
        na  = "related_v deo_t et_t et_based_enable_exper  ntal_s mclusters_ann",
        default = false
      )
  ...
  object EnableS mClustersANN1Param
      extends FSParam[Boolean](
        na  = "related_v deo_t et_t et_based_enable_s mclusters_ann_1",
        default = false
      )
  ...
  object EnableS mClustersANN2Param
      extends FSParam[Boolean](
        na  = "related_v deo_t et_t et_based_enable_s mclusters_ann_2",
        default = false
      )
  ...
  object EnableS mClustersANN3Param
      extends FSParam[Boolean](
        na  = "related_v deo_t et_t et_based_enable_s mclusters_ann_3",
        default = false
      )
  ...
  object EnableS mClustersANN5Param
      extends FSParam[Boolean](
        na  = "related_v deo_t et_t et_based_enable_s mclusters_ann_5",
        default = false
      )
  ...
  object EnableS mClustersANN4Param
      extends FSParam[Boolean](
        na  = "related_v deo_t et_t et_based_enable_s mclusters_ann_4",
        default = false
      )
  // TwH N params
  object EnableTwH NParam
      extends FSParam[Boolean](
        na  = "related_v deo_t et_t et_based_enable_twh n",
        default = false
      )
  ...
  object EnableQ gS m larT etsParam
      extends FSParam[Boolean](
        na  = "related_v deo_t et_t et_based_enable_q g_s m lar_t ets",
        default = false
      )
  ...
  object S mClustersM nScoreParam
      extends FSBoundedParam[Double](
        na  = "related_v deo_t et_t et_based_f lter_s mclusters_m n_score",
        default = 0.3,
        m n = 0.0,
        max = 1.0
      )
  ...
  object EnableUVGParam
      extends FSParam[Boolean](
        na  = "related_v deo_t et_t et_based_enable_uvg",
        default = false
      )
